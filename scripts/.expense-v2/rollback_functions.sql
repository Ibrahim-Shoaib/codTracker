-- get_daily_series
CREATE OR REPLACE FUNCTION public.get_daily_series(p_store_id text, p_from_date date, p_to_date date, p_monthly_expenses numeric, p_per_order_expenses numeric)
...
-- get_dashboard_stats
CREATE OR REPLACE FUNCTION public.get_dashboard_stats(p_store_id text, p_from_date date, p_to_date date, p_monthly_expenses numeric, p_per_order_expenses numeric)
...
-- get_trend_series
CREATE OR REPLACE FUNCTION public.get_trend_series(p_store_id text, p_from_date date, p_to_date date, p_monthly_expenses numeric, p_per_order_expenses numeric, p_granularity text DEFAULT 'day'::text)
